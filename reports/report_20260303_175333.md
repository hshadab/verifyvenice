...
- **70B Output Integrity:** Mean cosine similarity = 0.7132 [0.6092, 0.8066] across 50 test pairs (text-based comparison)
- **3B Output Integrity:** Mean token agreement = 0.1239 [0.0984, 0.1504] across 50 test pairs (logprob-based comparison)
